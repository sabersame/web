...
class Case_Login(Base_Base):
    ...
    def passwd_input_input(self, case_name, passwd):
        # 密码
        self.input(case_name, 'xpath', '//*[@id="app-el"]/div/div/div/div[2]/div/div[3]/input', passwd)

    def signup_button_click(self, case_name):
        # 登陆按钮
        self.click(case_name, 'xpath', '//*[@id="app-el"]/div/div/div/div[2]/div/div[4]/button')

    def userinfo_text_assertion(self, case_name):
        self.assertion(case_name, 'xpath', '//*[@id="app-el"]/div/div/div/div/div[1]/div[3]/div/div/div', "狗狗")

    def errorlogin_text_assertion(self, case_name):
        self.assertion(case_name, 'xpath', '//*[@id="app-el"]/div/div/div/div[2]/div/div[4]/div', '密码错误!')
